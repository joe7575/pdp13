techage.add_to_manual('DE', {
  ...
  "\n"..
  "Aufgrund der Länge der Länge der Anleitung ist diese nicht in-game verfügbar. Es empfiehlt sich hingegen\\, diese Anleitung direkt auf GitHub zu lesen oder von dort herunterzuladen. Über den Link 'github.com/joe7575/pdp13/wiki' kommst du direkt zu der Seite mit Anleitungen und weiteren Links.\n"..
  "\n"..
  "\n"..
  "\n",
}, {
